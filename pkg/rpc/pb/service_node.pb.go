...
var file_service_node_proto_rawDesc = []byte{
	...
	0x53, 0x4f, 0x4e, 0x22, 0x34, 0x0a, 0x1a, 0x46, 0x69, 0x6e, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x55,
	0x41, 0x4d, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x06, 0x6e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x22, 0xc3, 0x01, 0x0a, 0x1b, 0x46, 0x69,
	0x6e, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x55, 0x41, 0x4d, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a, 0x0b, 0x75, 0x61, 0x6d,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29,
	...
	0x55, 0x41, 0x4d, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x0b, 0x75, 0x61, 0x6d, 0x50, 0x6f,
	0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x1a, 0x57, 0x0a, 0x09, 0x55, 0x41, 0x4d, 0x50, 0x6f, 0x6c,
	...
	0x52, 0x0d, 0x75, 0x61, 0x6d, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4a, 0x53, 0x4f, 0x4e, 0x32,
	0xc2, 0x24, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
...
var file_service_node_proto_msgTypes = make([]protoimpl.MessageInfo, 84)
var file_service_node_proto_goTypes = []interface{}{
	...
	(*FindAllUpgradeNodesWithNodeClusterIdResponse_NodeUpgrade)(nil), // 81: pb.FindAllUpgradeNodesWithNodeClusterIdResponse.NodeUpgrade
	(*ListNodeRegionInfoResponse_Info)(nil),                          // 82: pb.ListNodeRegionInfoResponse.Info
	(*FindNodeUAMPoliciesResponse_UAMPolicy)(nil),                    // 83: pb.FindNodeUAMPoliciesResponse.UAMPolicy
	(*NodeLogin)(nil),                                                // 84: pb.NodeLogin
	(*Node)(nil),                                                     // 85: pb.Node
	(*BasicNode)(nil),                                                // 86: pb.BasicNode
	(*NodeInstallStatus)(nil),                                        // 87: pb.NodeInstallStatus
	(*DNSRoute)(nil),                                                 // 88: pb.DNSRoute
	(*SizeCapacity)(nil),                                             // 89: pb.SizeCapacity
	(*NodeRegion)(nil),                                               // 90: pb.NodeRegion
	(*NodeCluster)(nil),                                              // 91: pb.NodeCluster
	(*RPCCountResponse)(nil),                                         // 92: pb.RPCCountResponse
	(*RPCSuccess)(nil),                                               // 93: pb.RPCSuccess
}
var file_service_node_proto_depIdxs = []int32{
	84, // 0: pb.CreateNodeRequest.nodeLogin:type_name -> pb.NodeLogin
	85, // 1: pb.ListEnabledNodesMatchResponse.nodes:type_name -> pb.Node
	85, // 2: pb.FindAllEnabledNodesWithNodeClusterIdResponse.nodes:type_name -> pb.Node
	85, // 3: pb.FindEnabledNodeResponse.node:type_name -> pb.Node
	86, // 4: pb.FindEnabledBasicNodeResponse.node:type_name -> pb.BasicNode
	85, // 5: pb.FindAllEnabledNodesWithNodeGrantIdResponse.nodes:type_name -> pb.Node
	85, // 6: pb.FindAllNotInstalledNodesWithNodeClusterIdResponse.nodes:type_name -> pb.Node
	81, // 7: pb.FindAllUpgradeNodesWithNodeClusterIdResponse.nodes:type_name -> pb.FindAllUpgradeNodesWithNodeClusterIdResponse.NodeUpgrade
	87, // 8: pb.FindNodeInstallStatusResponse.installStatus:type_name -> pb.NodeInstallStatus
	84, // 9: pb.UpdateNodeLoginRequest.nodeLogin:type_name -> pb.NodeLogin
	46, // 10: pb.FindAllEnabledNodesDNSWithNodeClusterIdResponse.nodes:type_name -> pb.NodeDNSInfo
	88, // 11: pb.NodeDNSInfo.routes:type_name -> pb.DNSRoute
	46, // 12: pb.FindEnabledNodeDNSResponse.node:type_name -> pb.NodeDNSInfo
	85, // 13: pb.FindEnabledNodesWithIdsResponse.nodes:type_name -> pb.Node
	89, // 14: pb.UpdateNodeCacheRequest.maxCacheDiskCapacity:type_name -> pb.SizeCapacity
	89, // 15: pb.UpdateNodeCacheRequest.maxCacheMemoryCapacity:type_name -> pb.SizeCapacity
	82, // 16: pb.ListNodeRegionInfoResponse.infoList:type_name -> pb.ListNodeRegionInfoResponse.Info
	83, // 17: pb.FindNodeUAMPoliciesResponse.uamPolicies:type_name -> pb.FindNodeUAMPoliciesResponse.UAMPolicy
	85, // 18: pb.FindAllUpgradeNodesWithNodeClusterIdResponse.NodeUpgrade.node:type_name -> pb.Node
	90, // 19: pb.ListNodeRegionInfoResponse.Info.nodeRegion:type_name -> pb.NodeRegion
	91, // 20: pb.ListNodeRegionInfoResponse.Info.nodeCluster:type_name -> pb.NodeCluster
	0,  // 21: pb.NodeService.createNode:input_type -> pb.CreateNodeRequest
	2,  // 22: pb.NodeService.registerClusterNode:input_type -> pb.RegisterClusterNodeRequest
	4,  // 23: pb.NodeService.countAllEnabledNodes:input_type -> pb.CountAllEnabledNodesRequest
	20, // 24: pb.NodeService.countAllEnabledNodesMatch:input_type -> pb.CountAllEnabledNodesMatchRequest
	5,  // 25: pb.NodeService.listEnabledNodesMatch:input_type -> pb.ListEnabledNodesMatchRequest
	7,  // 26: pb.NodeService.findAllEnabledNodesWithNodeClusterId:input_type -> pb.FindAllEnabledNodesWithNodeClusterIdRequest
	9,  // 27: pb.NodeService.deleteNode:input_type -> pb.DeleteNodeRequest
	10, // 28: pb.NodeService.deleteNodeFromNodeCluster:input_type -> pb.DeleteNodeFromNodeClusterRequest
	11, // 29: pb.NodeService.updateNode:input_type -> pb.UpdateNodeRequest
	12, // 30: pb.NodeService.findEnabledNode:input_type -> pb.FindEnabledNodeRequest
	14, // 31: pb.NodeService.findEnabledBasicNode:input_type -> pb.FindEnabledBasicNodeRequest
	16, // 32: pb.NodeService.findCurrentNodeConfig:input_type -> pb.FindCurrentNodeConfigRequest
	18, // 33: pb.NodeService.nodeStream:input_type -> pb.NodeStreamMessage
	18, // 34: pb.NodeService.sendCommandToNode:input_type -> pb.NodeStreamMessage
	19, // 35: pb.NodeService.updateNodeStatus:input_type -> pb.UpdateNodeStatusRequest
	21, // 36: pb.NodeService.updateNodeIsInstalled:input_type -> pb.UpdateNodeIsInstalledRequest
	22, // 37: pb.NodeService.installNode:input_type -> pb.InstallNodeRequest
	24, // 38: pb.NodeService.upgradeNode:input_type -> pb.UpgradeNodeRequest
	26, // 39: pb.NodeService.startNode:input_type -> pb.StartNodeRequest
	28, // 40: pb.NodeService.stopNode:input_type -> pb.StopNodeRequest
	30, // 41: pb.NodeService.updateNodeConnectedAPINodes:input_type -> pb.UpdateNodeConnectedAPINodesRequest
	31, // 42: pb.NodeService.countAllEnabledNodesWithNodeGrantId:input_type -> pb.CountAllEnabledNodesWithNodeGrantIdRequest
	32, // 43: pb.NodeService.findAllEnabledNodesWithNodeGrantId:input_type -> pb.FindAllEnabledNodesWithNodeGrantIdRequest
	36, // 44: pb.NodeService.countAllNotInstalledNodesWithNodeClusterId:input_type -> pb.CountAllNotInstalledNodesWithNodeClusterIdRequest
	34, // 45: pb.NodeService.findAllNotInstalledNodesWithNodeClusterId:input_type -> pb.FindAllNotInstalledNodesWithNodeClusterIdRequest
	37, // 46: pb.NodeService.countAllUpgradeNodesWithNodeClusterId:input_type -> pb.CountAllUpgradeNodesWithNodeClusterIdRequest
	38, // 47: pb.NodeService.findAllUpgradeNodesWithNodeClusterId:input_type -> pb.FindAllUpgradeNodesWithNodeClusterIdRequest
	40, // 48: pb.NodeService.findNodeInstallStatus:input_type -> pb.FindNodeInstallStatusRequest
	42, // 49: pb.NodeService.updateNodeLogin:input_type -> pb.UpdateNodeLoginRequest
	43, // 50: pb.NodeService.countAllEnabledNodesWithNodeGroupId:input_type -> pb.CountAllEnabledNodesWithNodeGroupIdRequest
	44, // 51: pb.NodeService.findAllEnabledNodesDNSWithNodeClusterId:input_type -> pb.FindAllEnabledNodesDNSWithNodeClusterIdRequest
	47, // 52: pb.NodeService.findEnabledNodeDNS:input_type -> pb.FindEnabledNodeDNSRequest
	49, // 53: pb.NodeService.updateNodeDNS:input_type -> pb.UpdateNodeDNSRequest
	50, // 54: pb.NodeService.countAllEnabledNodesWithNodeRegionId:input_type -> pb.CountAllEnabledNodesWithNodeRegionIdRequest
	51, // 55: pb.NodeService.findEnabledNodesWithIds:input_type -> pb.FindEnabledNodesWithIdsRequest
	53, // 56: pb.NodeService.checkNodeLatestVersion:input_type -> pb.CheckNodeLatestVersionRequest
	55, // 57: pb.NodeService.updateNodeUp:input_type -> pb.UpdateNodeUpRequest
	56, // 58: pb.NodeService.downloadNodeInstallationFile:input_type -> pb.DownloadNodeInstallationFileRequest
	58, // 59: pb.NodeService.updateNodeSystem:input_type -> pb.UpdateNodeSystemRequest
	59, // 60: pb.NodeService.updateNodeCache:input_type -> pb.UpdateNodeCacheRequest
	60, // 61: pb.NodeService.findNodeLevelInfo:input_type -> pb.FindNodeLevelInfoRequest
	62, // 62: pb.NodeService.findNodeDNSResolver:input_type -> pb.FindNodeDNSResolverRequest
	64, // 63: pb.NodeService.updateNodeDNSResolver:input_type -> pb.UpdateNodeDNSResolverRequest
	65, // 64: pb.NodeService.findNodeDDoSProtection:input_type -> pb.FindNodeDDoSProtectionRequest
	67, // 65: pb.NodeService.updateNodeDDoSProtection:input_type -> pb.UpdateNodeDDoSProtectionRequest
	68, // 66: pb.NodeService.findNodeGlobalServerConfig:input_type -> pb.FindNodeGlobalServerConfigRequest
	70, // 67: pb.NodeService.findEnabledNodeConfigInfo:input_type -> pb.FindEnabledNodeConfigInfoRequest
	72, // 68: pb.NodeService.countAllNodeRegionInfo:input_type -> pb.CountAllNodeRegionInfoRequest
	73, // 69: pb.NodeService.listNodeRegionInfo:input_type -> pb.ListNodeRegionInfoRequest
	75, // 70: pb.NodeService.updateNodeRegionInfo:input_type -> pb.UpdateNodeRegionInfoRequest
	76, // 71: pb.NodeService.findNodeAPIConfig:input_type -> pb.FindNodeAPIConfigRequest
	78, // 72: pb.NodeService.updateNodeAPIConfig:input_type -> pb.UpdateNodeAPIConfigRequest
	79, // 73: pb.NodeService.findNodeUAMPolicies:input_type -> pb.FindNodeUAMPoliciesRequest
	1,  // 74: pb.NodeService.createNode:output_type -> pb.CreateNodeResponse
	3,  // 75: pb.NodeService.registerClusterNode:output_type -> pb.RegisterClusterNodeResponse
	92, // 76: pb.NodeService.countAllEnabledNodes:output_type -> pb.RPCCountResponse
	92, // 77: pb.NodeService.countAllEnabledNodesMatch:output_type -> pb.RPCCountResponse
	6,  // 78: pb.NodeService.listEnabledNodesMatch:output_type -> pb.ListEnabledNodesMatchResponse
	8,  // 79: pb.NodeService.findAllEnabledNodesWithNodeClusterId:output_type -> pb.FindAllEnabledNodesWithNodeClusterIdResponse
	93, // 80: pb.NodeService.deleteNode:output_type -> pb.RPCSuccess
	93, // 81: pb.NodeService.deleteNodeFromNodeCluster:output_type -> pb.RPCSuccess
	93, // 82: pb.NodeService.updateNode:output_type -> pb.RPCSuccess
	13, // 83: pb.NodeService.findEnabledNode:output_type -> pb.FindEnabledNodeResponse
	15, // 84: pb.NodeService.findEnabledBasicNode:output_type -> pb.FindEnabledBasicNodeResponse
	17, // 85: pb.NodeService.findCurrentNodeConfig:output_type -> pb.FindCurrentNodeConfigResponse
	18, // 86: pb.NodeService.nodeStream:output_type -> pb.NodeStreamMessage
	18, // 87: pb.NodeService.sendCommandToNode:output_type -> pb.NodeStreamMessage
	93, // 88: pb.NodeService.updateNodeStatus:output_type -> pb.RPCSuccess
	93, // 89: pb.NodeService.updateNodeIsInstalled:output_type -> pb.RPCSuccess
	23, // 90: pb.NodeService.installNode:output_type -> pb.InstallNodeResponse
	25, // 91: pb.NodeService.upgradeNode:output_type -> pb.UpgradeNodeResponse
	27, // 92: pb.NodeService.startNode:output_type -> pb.StartNodeResponse
	29, // 93: pb.NodeService.stopNode:output_type -> pb.StopNodeResponse
	93, // 94: pb.NodeService.updateNodeConnectedAPINodes:output_type -> pb.RPCSuccess
	92, // 95: pb.NodeService.countAllEnabledNodesWithNodeGrantId:output_type -> pb.RPCCountResponse
	33, // 96: pb.NodeService.findAllEnabledNodesWithNodeGrantId:output_type -> pb.FindAllEnabledNodesWithNodeGrantIdResponse
	92, // 97: pb.NodeService.countAllNotInstalledNodesWithNodeClusterId:output_type -> pb.RPCCountResponse
	35, // 98: pb.NodeService.findAllNotInstalledNodesWithNodeClusterId:output_type -> pb.FindAllNotInstalledNodesWithNodeClusterIdResponse
	92, // 99: pb.NodeService.countAllUpgradeNodesWithNodeClusterId:output_type -> pb.RPCCountResponse
	39, // 100: pb.NodeService.findAllUpgradeNodesWithNodeClusterId:output_type -> pb.FindAllUpgradeNodesWithNodeClusterIdResponse
	41, // 101: pb.NodeService.findNodeInstallStatus:output_type -> pb.FindNodeInstallStatusResponse
	93, // 102: pb.NodeService.updateNodeLogin:output_type -> pb.RPCSuccess
	92, // 103: pb.NodeService.countAllEnabledNodesWithNodeGroupId:output_type -> pb.RPCCountResponse
	45, // 104: pb.NodeService.findAllEnabledNodesDNSWithNodeClusterId:output_type -> pb.FindAllEnabledNodesDNSWithNodeClusterIdResponse
	48, // 105: pb.NodeService.findEnabledNodeDNS:output_type -> pb.FindEnabledNodeDNSResponse
	93, // 106: pb.NodeService.updateNodeDNS:output_type -> pb.RPCSuccess
	92, // 107: pb.NodeService.countAllEnabledNodesWithNodeRegionId:output_type -> pb.RPCCountResponse
	52, // 108: pb.NodeService.findEnabledNodesWithIds:output_type -> pb.FindEnabledNodesWithIdsResponse
	54, // 109: pb.NodeService.checkNodeLatestVersion:output_type -> pb.CheckNodeLatestVersionResponse
	93, // 110: pb.NodeService.updateNodeUp:output_type -> pb.RPCSuccess
	57, // 111: pb.NodeService.downloadNodeInstallationFile:output_type -> pb.DownloadNodeInstallationFileResponse
	93, // 112: pb.NodeService.updateNodeSystem:output_type -> pb.RPCSuccess
	93, // 113: pb.NodeService.updateNodeCache:output_type -> pb.RPCSuccess
	61, // 114: pb.NodeService.findNodeLevelInfo:output_type -> pb.FindNodeLevelInfoResponse
	63, // 115: pb.NodeService.findNodeDNSResolver:output_type -> pb.FindNodeDNSResolverResponse
	93, // 116: pb.NodeService.updateNodeDNSResolver:output_type -> pb.RPCSuccess
	66, // 117: pb.NodeService.findNodeDDoSProtection:output_type -> pb.FindNodeDDoSProtectionResponse
	93, // 118: pb.NodeService.updateNodeDDoSProtection:output_type -> pb.RPCSuccess
	69, // 119: pb.NodeService.findNodeGlobalServerConfig:output_type -> pb.FindNodeGlobalServerConfigResponse
	71, // 120: pb.NodeService.findEnabledNodeConfigInfo:output_type -> pb.FindEnabledNodeConfigInfoResponse
	92, // 121: pb.NodeService.countAllNodeRegionInfo:output_type -> pb.RPCCountResponse
	74, // 122: pb.NodeService.listNodeRegionInfo:output_type -> pb.ListNodeRegionInfoResponse
	93, // 123: pb.NodeService.updateNodeRegionInfo:output_type -> pb.RPCSuccess
	77, // 124: pb.NodeService.findNodeAPIConfig:output_type -> pb.FindNodeAPIConfigResponse
	93, // 125: pb.NodeService.updateNodeAPIConfig:output_type -> pb.RPCSuccess
	80, // 126: pb.NodeService.findNodeUAMPolicies:output_type -> pb.FindNodeUAMPoliciesResponse
