...
var file_service_node_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_service_node_proto_goTypes = []interface{}{
	...
	(*FindAllUpgradeNodesWithClusterIdResponse_NodeUpgrade)(nil), // 42: pb.FindAllUpgradeNodesWithClusterIdResponse.NodeUpgrade
	(*NodeLogin)(nil),                                            // 43: pb.NodeLogin
	(*Node)(nil),                                                 // 44: pb.Node
...
var file_service_node_proto_depIdxs = []int32{
	...
	44, // 1: pb.ListEnabledNodesMatchResponse.nodes:type_name -> pb.Node
	44, // 2: pb.FindAllEnabledNodesWithClusterIdResponse.nodes:type_name -> pb.Node
	43, // 3: pb.UpdateNodeRequest.Login:type_name -> pb.NodeLogin
	44, // 4: pb.FindEnabledNodeResponse.node:type_name -> pb.Node
	44, // 5: pb.FindAllEnabledNodesWithGrantIdResponse.nodes:type_name -> pb.Node
	44, // 6: pb.FindAllNotInstalledNodesWithClusterIdResponse.nodes:type_name -> pb.Node
	42, // 7: pb.FindAllUpgradeNodesWithClusterIdResponse.nodes:type_name -> pb.FindAllUpgradeNodesWithClusterIdResponse.NodeUpgrade
	45, // 8: pb.FindNodeInstallStatusResponse.installStatus:type_name -> pb.NodeInstallStatus
	43, // 9: pb.UpdateNodeLoginRequest.Login:type_name -> pb.NodeLogin
	44, // 10: pb.FindAllUpgradeNodesWithClusterIdResponse.NodeUpgrade.node:type_name -> pb.Node
	...
	20, // 14: pb.NodeService.countAllEnabledNodesMatch:input_type -> pb.CountAllEnabledNodesMatchRequest
	5,  // 15: pb.NodeService.listEnabledNodesMatch:input_type -> pb.ListEnabledNodesMatchRequest
	7,  // 16: pb.NodeService.findAllEnabledNodesWithClusterId:input_type -> pb.FindAllEnabledNodesWithClusterIdRequest
	9,  // 17: pb.NodeService.disableNode:input_type -> pb.DisableNodeRequest
	11, // 18: pb.NodeService.updateNode:input_type -> pb.UpdateNodeRequest
	12, // 19: pb.NodeService.findEnabledNode:input_type -> pb.FindEnabledNodeRequest
	14, // 20: pb.NodeService.findCurrentNodeConfig:input_type -> pb.FindCurrentNodeConfigRequest
	16, // 21: pb.NodeService.nodeStream:input_type -> pb.NodeStreamMessage
	16, // 22: pb.NodeService.sendCommandToNode:input_type -> pb.NodeStreamMessage
	17, // 23: pb.NodeService.updateNodeStatus:input_type -> pb.UpdateNodeStatusRequest
	18, // 24: pb.NodeService.syncNodesVersionWithCluster:input_type -> pb.SyncNodesVersionWithClusterRequest
	21, // 25: pb.NodeService.updateNodeIsInstalled:input_type -> pb.UpdateNodeIsInstalledRequest
	22, // 26: pb.NodeService.installNode:input_type -> pb.InstallNodeRequest
	24, // 27: pb.NodeService.upgradeNode:input_type -> pb.UpgradeNodeRequest
	26, // 28: pb.NodeService.startNode:input_type -> pb.StartNodeRequest
	28, // 29: pb.NodeService.stopNode:input_type -> pb.StopNodeRequest
	30, // 30: pb.NodeService.updateNodeConnectedAPINodes:input_type -> pb.UpdateNodeConnectedAPINodesRequest
	31, // 31: pb.NodeService.countAllEnabledNodesWithGrantId:input_type -> pb.CountAllEnabledNodesWithGrantIdRequest
	32, // 32: pb.NodeService.findAllEnabledNodesWithGrantId:input_type -> pb.FindAllEnabledNodesWithGrantIdRequest
	34, // 33: pb.NodeService.findAllNotInstalledNodesWithClusterId:input_type -> pb.FindAllNotInstalledNodesWithClusterIdRequest
	36, // 34: pb.NodeService.findAllUpgradeNodesWithClusterId:input_type -> pb.FindAllUpgradeNodesWithClusterIdRequest
	38, // 35: pb.NodeService.findNodeInstallStatus:input_type -> pb.FindNodeInstallStatusRequest
	40, // 36: pb.NodeService.updateNodeLogin:input_type -> pb.UpdateNodeLoginRequest
	41, // 37: pb.NodeService.countAllEnabledNodesWithGroupId:input_type -> pb.CountAllEnabledNodesWithGroupIdRequest
	...
	46, // 40: pb.NodeService.countAllEnabledNodes:output_type -> pb.RPCCountResponse
	46, // 41: pb.NodeService.countAllEnabledNodesMatch:output_type -> pb.RPCCountResponse
