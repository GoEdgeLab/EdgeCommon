...
var file_service_ns_cluster_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0c, 0x52, 0x07, 0x75, 0x64, 0x70, 0x4a, 0x53, 0x4f, 0x4e, 0x32, 0xc2, 0x0b, 0x0a,
...
var file_service_ns_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
...
var file_service_ns_cluster_proto_depIdxs = []int32{
	26, // 0: pb.FindEnabledNSClusterResponse.nsCluster:type_name -> pb.NSCluster
	26, // 1: pb.ListEnabledNSClustersResponse.nsClusters:type_name -> pb.NSCluster
	26, // 2: pb.FindAllEnabledNSClustersResponse.nsClusters:type_name -> pb.NSCluster
	...
	1,  // 20: pb.NSClusterService.createNSCluster:output_type -> pb.CreateNSClusterResponse
	27, // 21: pb.NSClusterService.updateNSCluster:output_type -> pb.RPCSuccess
	4,  // 22: pb.NSClusterService.findNSClusterAccessLog:output_type -> pb.FindNSClusterAccessLogResponse
	27, // 23: pb.NSClusterService.updateNSClusterAccessLog:output_type -> pb.RPCSuccess
	27, // 24: pb.NSClusterService.deleteNSCluster:output_type -> pb.RPCSuccess
	8,  // 25: pb.NSClusterService.findEnabledNSCluster:output_type -> pb.FindEnabledNSClusterResponse
	28, // 26: pb.NSClusterService.countAllEnabledNSClusters:output_type -> pb.RPCCountResponse
	11, // 27: pb.NSClusterService.listEnabledNSClusters:output_type -> pb.ListEnabledNSClustersResponse
	13, // 28: pb.NSClusterService.findAllEnabledNSClusters:output_type -> pb.FindAllEnabledNSClustersResponse
	27, // 29: pb.NSClusterService.updateNSClusterRecursionConfig:output_type -> pb.RPCSuccess
	16, // 30: pb.NSClusterService.findNSClusterRecursionConfig:output_type -> pb.FindNSClusterRecursionConfigResponse
	18, // 31: pb.NSClusterService.findNSClusterTCPConfig:output_type -> pb.FindNSClusterTCPConfigResponse
	27, // 32: pb.NSClusterService.updateNSClusterTCP:output_type -> pb.RPCSuccess
	20, // 33: pb.NSClusterService.findNSClusterTLSConfig:output_type -> pb.FindNSClusterTLSConfigResponse
	27, // 34: pb.NSClusterService.updateNSClusterTLS:output_type -> pb.RPCSuccess
	22, // 35: pb.NSClusterService.findNSClusterUDPConfig:output_type -> pb.FindNSClusterUDPConfigResponse
	27, // 36: pb.NSClusterService.updateNSClusterUDP:output_type -> pb.RPCSuccess
