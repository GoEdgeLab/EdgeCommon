...
var file_service_server_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xc6, 0x17,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x67, 0x0a, 0x21, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41,
	0x6c, 0x6c, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73,
	0x57, 0x69, 0x74, 0x68, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x2c, 0x2e, 0x70, 0x62,
	...
	0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x57, 0x69, 0x74, 0x68, 0x55, 0x73, 0x65, 0x72, 0x49,
	0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6b, 0x0a, 0x1a, 0x66, 0x69, 0x6e,
...
var file_service_server_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_service_server_proto_goTypes = []interface{}{
	...
	(*UploadServerHTTPRequestStatRequest_RegionCity)(nil),            // 49: pb.UploadServerHTTPRequestStatRequest.RegionCity
	(*UploadServerHTTPRequestStatRequest_RegionProvider)(nil),        // 50: pb.UploadServerHTTPRequestStatRequest.RegionProvider
	(*UploadServerHTTPRequestStatRequest_System)(nil),                // 51: pb.UploadServerHTTPRequestStatRequest.System
	(*UploadServerHTTPRequestStatRequest_Browser)(nil),               // 52: pb.UploadServerHTTPRequestStatRequest.Browser
	(*UploadServerHTTPRequestStatRequest_HTTPFirewallRuleGroup)(nil), // 53: pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	(*ServerNameAuditingResult)(nil),                                 // 54: pb.ServerNameAuditingResult
	(*Server)(nil),                                                   // 55: pb.Server
	(*DNSDomain)(nil),                                                // 56: pb.DNSDomain
	(*RPCSuccess)(nil),                                               // 57: pb.RPCSuccess
	(*RPCCountResponse)(nil),                                         // 58: pb.RPCCountResponse
}
var file_service_server_proto_depIdxs = []int32{
	54, // 0: pb.FindServerNamesResponse.auditingResult:type_name -> pb.ServerNameAuditingResult
	54, // 1: pb.UpdateServerNamesAuditingRequest.auditingResult:type_name -> pb.ServerNameAuditingResult
	55, // 2: pb.ListEnabledServersMatchResponse.servers:type_name -> pb.Server
	55, // 3: pb.FindEnabledServerResponse.server:type_name -> pb.Server
	55, // 4: pb.FindAllEnabledServersWithSSLCertIdResponse.servers:type_name -> pb.Server
	39, // 5: pb.FindAllEnabledServersDNSWithClusterIdResponse.servers:type_name -> pb.ServerDNSInfo
	56, // 6: pb.FindEnabledServerDNSResponse.domain:type_name -> pb.DNSDomain
	55, // 7: pb.FindEnabledUserServerBasicResponse.server:type_name -> pb.Server
	49, // 8: pb.UploadServerHTTPRequestStatRequest.regionCities:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionCity
	50, // 9: pb.UploadServerHTTPRequestStatRequest.regionProviders:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionProvider
	51, // 10: pb.UploadServerHTTPRequestStatRequest.systems:type_name -> pb.UploadServerHTTPRequestStatRequest.System
	52, // 11: pb.UploadServerHTTPRequestStatRequest.browsers:type_name -> pb.UploadServerHTTPRequestStatRequest.Browser
	53, // 12: pb.UploadServerHTTPRequestStatRequest.httpFirewallRuleGroups:type_name -> pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	...
	1,  // 47: pb.ServerService.createServer:output_type -> pb.CreateServerResponse
	57, // 48: pb.ServerService.updateServerBasic:output_type -> pb.RPCSuccess
	57, // 49: pb.ServerService.updateServerIsOn:output_type -> pb.RPCSuccess
	57, // 50: pb.ServerService.updateServerHTTP:output_type -> pb.RPCSuccess
	57, // 51: pb.ServerService.updateServerHTTPS:output_type -> pb.RPCSuccess
	57, // 52: pb.ServerService.updateServerTCP:output_type -> pb.RPCSuccess
	57, // 53: pb.ServerService.updateServerTLS:output_type -> pb.RPCSuccess
	57, // 54: pb.ServerService.updateServerUnix:output_type -> pb.RPCSuccess
	57, // 55: pb.ServerService.updateServerUDP:output_type -> pb.RPCSuccess
	57, // 56: pb.ServerService.updateServerWeb:output_type -> pb.RPCSuccess
	57, // 57: pb.ServerService.updateServerReverseProxy:output_type -> pb.RPCSuccess
	13, // 58: pb.ServerService.findServerNames:output_type -> pb.FindServerNamesResponse
	57, // 59: pb.ServerService.updateServerNames:output_type -> pb.RPCSuccess
	57, // 60: pb.ServerService.updateServerNamesAuditing:output_type -> pb.RPCSuccess
	58, // 61: pb.ServerService.countAllEnabledServersMatch:output_type -> pb.RPCCountResponse
	18, // 62: pb.ServerService.listEnabledServersMatch:output_type -> pb.ListEnabledServersMatchResponse
	57, // 63: pb.ServerService.deleteServer:output_type -> pb.RPCSuccess
	21, // 64: pb.ServerService.findEnabledServer:output_type -> pb.FindEnabledServerResponse
	23, // 65: pb.ServerService.findEnabledServerConfig:output_type -> pb.FindEnabledServerConfigResponse
	25, // 66: pb.ServerService.findEnabledServerType:output_type -> pb.FindEnabledServerTypeResponse
	27, // 67: pb.ServerService.findAndInitServerReverseProxyConfig:output_type -> pb.FindAndInitServerReverseProxyConfigResponse
	29, // 68: pb.ServerService.findAndInitServerWebConfig:output_type -> pb.FindAndInitServerWebConfigResponse
	58, // 69: pb.ServerService.countAllEnabledServersWithSSLCertId:output_type -> pb.RPCCountResponse
	32, // 70: pb.ServerService.findAllEnabledServersWithSSLCertId:output_type -> pb.FindAllEnabledServersWithSSLCertIdResponse
	58, // 71: pb.ServerService.countAllEnabledServersWithNodeClusterId:output_type -> pb.RPCCountResponse
	58, // 72: pb.ServerService.countAllEnabledServersWithGroupId:output_type -> pb.RPCCountResponse
	36, // 73: pb.ServerService.notifyServersChange:output_type -> pb.NotifyServersChangeResponse
	38, // 74: pb.ServerService.findAllEnabledServersDNSWithClusterId:output_type -> pb.FindAllEnabledServersDNSWithClusterIdResponse
	41, // 75: pb.ServerService.findEnabledServerDNS:output_type -> pb.FindEnabledServerDNSResponse
	57, // 76: pb.ServerService.checkUserServer:output_type -> pb.RPCSuccess
	44, // 77: pb.ServerService.findAllEnabledServerNamesWithUserId:output_type -> pb.FindAllEnabledServerNamesWithUserIdResponse
	46, // 78: pb.ServerService.findEnabledUserServerBasic:output_type -> pb.FindEnabledUserServerBasicResponse
	57, // 79: pb.ServerService.updateEnabledUserServerBasic:output_type -> pb.RPCSuccess
	57, // 80: pb.ServerService.uploadServerHTTPRequestStat:output_type -> pb.RPCSuccess
