...
var file_service_server_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x32, 0xa1, 0x1b, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76,
...
var file_service_server_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_service_server_proto_goTypes = []interface{}{
	...
	(*UploadServerHTTPRequestStatRequest_RegionCity)(nil),            // 57: pb.UploadServerHTTPRequestStatRequest.RegionCity
	(*UploadServerHTTPRequestStatRequest_RegionProvider)(nil),        // 58: pb.UploadServerHTTPRequestStatRequest.RegionProvider
	(*UploadServerHTTPRequestStatRequest_System)(nil),                // 59: pb.UploadServerHTTPRequestStatRequest.System
	(*UploadServerHTTPRequestStatRequest_Browser)(nil),               // 60: pb.UploadServerHTTPRequestStatRequest.Browser
	(*UploadServerHTTPRequestStatRequest_HTTPFirewallRuleGroup)(nil), // 61: pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	(*FindNearbyServersResponse_GroupInfo)(nil),                      // 62: pb.FindNearbyServersResponse.GroupInfo
	(*ServerNameAuditingResult)(nil),                                 // 63: pb.ServerNameAuditingResult
	(*Server)(nil),                                                   // 64: pb.Server
	(*DNSDomain)(nil),                                                // 65: pb.DNSDomain
	(*RPCSuccess)(nil),                                               // 66: pb.RPCSuccess
	(*RPCCountResponse)(nil),                                         // 67: pb.RPCCountResponse
}
var file_service_server_proto_depIdxs = []int32{
	63, // 0: pb.FindServerNamesResponse.auditingResult:type_name -> pb.ServerNameAuditingResult
	63, // 1: pb.UpdateServerNamesAuditingRequest.auditingResult:type_name -> pb.ServerNameAuditingResult
	64, // 2: pb.ListEnabledServersMatchResponse.servers:type_name -> pb.Server
	64, // 3: pb.FindEnabledServerResponse.server:type_name -> pb.Server
	64, // 4: pb.FindAllEnabledServersWithSSLCertIdResponse.servers:type_name -> pb.Server
	41, // 5: pb.FindAllEnabledServersDNSWithNodeClusterIdResponse.servers:type_name -> pb.ServerDNSInfo
	65, // 6: pb.FindEnabledServerDNSResponse.domain:type_name -> pb.DNSDomain
	64, // 7: pb.FindEnabledUserServerBasicResponse.server:type_name -> pb.Server
	57, // 8: pb.UploadServerHTTPRequestStatRequest.regionCities:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionCity
	58, // 9: pb.UploadServerHTTPRequestStatRequest.regionProviders:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionProvider
	59, // 10: pb.UploadServerHTTPRequestStatRequest.systems:type_name -> pb.UploadServerHTTPRequestStatRequest.System
	60, // 11: pb.UploadServerHTTPRequestStatRequest.browsers:type_name -> pb.UploadServerHTTPRequestStatRequest.Browser
	61, // 12: pb.UploadServerHTTPRequestStatRequest.httpFirewallRuleGroups:type_name -> pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	64, // 13: pb.FindLatestServersResponse.servers:type_name -> pb.Server
	62, // 14: pb.FindNearbyServersResponse.groups:type_name -> pb.FindNearbyServersResponse.GroupInfo
	64, // 15: pb.FindNearbyServersResponse.GroupInfo.servers:type_name -> pb.Server
	...
	1,  // 55: pb.ServerService.createServer:output_type -> pb.CreateServerResponse
	66, // 56: pb.ServerService.updateServerBasic:output_type -> pb.RPCSuccess
	66, // 57: pb.ServerService.updateServerIsOn:output_type -> pb.RPCSuccess
	66, // 58: pb.ServerService.updateServerHTTP:output_type -> pb.RPCSuccess
	66, // 59: pb.ServerService.updateServerHTTPS:output_type -> pb.RPCSuccess
	66, // 60: pb.ServerService.updateServerTCP:output_type -> pb.RPCSuccess
	66, // 61: pb.ServerService.updateServerTLS:output_type -> pb.RPCSuccess
	66, // 62: pb.ServerService.updateServerUnix:output_type -> pb.RPCSuccess
	66, // 63: pb.ServerService.updateServerUDP:output_type -> pb.RPCSuccess
	66, // 64: pb.ServerService.updateServerWeb:output_type -> pb.RPCSuccess
	66, // 65: pb.ServerService.updateServerReverseProxy:output_type -> pb.RPCSuccess
	13, // 66: pb.ServerService.findServerNames:output_type -> pb.FindServerNamesResponse
	66, // 67: pb.ServerService.updateServerNames:output_type -> pb.RPCSuccess
	66, // 68: pb.ServerService.updateServerNamesAuditing:output_type -> pb.RPCSuccess
	66, // 69: pb.ServerService.updateServerDNS:output_type -> pb.RPCSuccess
	66, // 70: pb.ServerService.regenerateServerCNAME:output_type -> pb.RPCSuccess
	67, // 71: pb.ServerService.countAllEnabledServersMatch:output_type -> pb.RPCCountResponse
	20, // 72: pb.ServerService.listEnabledServersMatch:output_type -> pb.ListEnabledServersMatchResponse
	66, // 73: pb.ServerService.deleteServer:output_type -> pb.RPCSuccess
	23, // 74: pb.ServerService.findEnabledServer:output_type -> pb.FindEnabledServerResponse
	25, // 75: pb.ServerService.findEnabledServerConfig:output_type -> pb.FindEnabledServerConfigResponse
	27, // 76: pb.ServerService.findEnabledServerType:output_type -> pb.FindEnabledServerTypeResponse
	29, // 77: pb.ServerService.findAndInitServerReverseProxyConfig:output_type -> pb.FindAndInitServerReverseProxyConfigResponse
	31, // 78: pb.ServerService.findAndInitServerWebConfig:output_type -> pb.FindAndInitServerWebConfigResponse
	67, // 79: pb.ServerService.countAllEnabledServersWithSSLCertId:output_type -> pb.RPCCountResponse
	34, // 80: pb.ServerService.findAllEnabledServersWithSSLCertId:output_type -> pb.FindAllEnabledServersWithSSLCertIdResponse
	67, // 81: pb.ServerService.countAllEnabledServersWithNodeClusterId:output_type -> pb.RPCCountResponse
	67, // 82: pb.ServerService.countAllEnabledServersWithServerGroupId:output_type -> pb.RPCCountResponse
	38, // 83: pb.ServerService.notifyServersChange:output_type -> pb.NotifyServersChangeResponse
	40, // 84: pb.ServerService.findAllEnabledServersDNSWithNodeClusterId:output_type -> pb.FindAllEnabledServersDNSWithNodeClusterIdResponse
	43, // 85: pb.ServerService.findEnabledServerDNS:output_type -> pb.FindEnabledServerDNSResponse
	66, // 86: pb.ServerService.checkUserServer:output_type -> pb.RPCSuccess
	46, // 87: pb.ServerService.findAllEnabledServerNamesWithUserId:output_type -> pb.FindAllEnabledServerNamesWithUserIdResponse
	48, // 88: pb.ServerService.findEnabledUserServerBasic:output_type -> pb.FindEnabledUserServerBasicResponse
	66, // 89: pb.ServerService.updateEnabledUserServerBasic:output_type -> pb.RPCSuccess
	66, // 90: pb.ServerService.uploadServerHTTPRequestStat:output_type -> pb.RPCSuccess
	52, // 91: pb.ServerService.checkServerNameDuplicationInNodeCluster:output_type -> pb.CheckServerNameDuplicationInNodeClusterResponse
	54, // 92: pb.ServerService.findLatestServers:output_type -> pb.FindLatestServersResponse
	56, // 93: pb.ServerService.findNearbyServers:output_type -> pb.FindNearbyServersResponse
