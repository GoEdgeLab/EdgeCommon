...
var file_service_server_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x64, 0x32, 0xa0, 0x14, 0x0a, 0x0d, 0x53, 0x65, 0x72,
	...
	0x65, 0x12, 0x67, 0x0a, 0x21, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x6c, 0x6c, 0x45, 0x6e, 0x61,
	0x62, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x57, 0x69, 0x74, 0x68, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12, 0x2c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x41, 0x6c, 0x6c, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x73, 0x57, 0x69, 0x74, 0x68, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x52, 0x65, 0x71,
	...
	0x73, 0x65, 0x12, 0x8c, 0x01, 0x0a, 0x25, 0x66, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x45, 0x6e,
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x44, 0x4e, 0x53, 0x57,
...
var file_service_server_proto_goTypes = []interface{}{
	...
	(*ServerNameAuditingResult)(nil),                       // 43: pb.ServerNameAuditingResult
	(*Server)(nil),                                         // 44: pb.Server
	(*DNSDomain)(nil),                                      // 45: pb.DNSDomain
	(*RPCSuccess)(nil),                                     // 46: pb.RPCSuccess
	(*RPCCountResponse)(nil),                               // 47: pb.RPCCountResponse
}
var file_service_server_proto_depIdxs = []int32{
	43, // 0: pb.FindServerNamesResponse.auditingResult:type_name -> pb.ServerNameAuditingResult
	43, // 1: pb.UpdateServerNamesAuditingRequest.auditingResult:type_name -> pb.ServerNameAuditingResult
	44, // 2: pb.ListEnabledServersMatchResponse.servers:type_name -> pb.Server
	44, // 3: pb.FindEnabledServerResponse.server:type_name -> pb.Server
	44, // 4: pb.FindAllEnabledServersWithSSLCertIdResponse.servers:type_name -> pb.Server
	39, // 5: pb.FindAllEnabledServersDNSWithClusterIdResponse.servers:type_name -> pb.ServerDNSInfo
	45, // 6: pb.FindEnabledServerDNSResponse.domain:type_name -> pb.DNSDomain
	...
	46, // 38: pb.ServerService.updateServerBasic:output_type -> pb.RPCSuccess
	46, // 39: pb.ServerService.updateServerIsOn:output_type -> pb.RPCSuccess
	46, // 40: pb.ServerService.updateServerHTTP:output_type -> pb.RPCSuccess
	46, // 41: pb.ServerService.updateServerHTTPS:output_type -> pb.RPCSuccess
	46, // 42: pb.ServerService.updateServerTCP:output_type -> pb.RPCSuccess
	46, // 43: pb.ServerService.updateServerTLS:output_type -> pb.RPCSuccess
	46, // 44: pb.ServerService.updateServerUnix:output_type -> pb.RPCSuccess
	46, // 45: pb.ServerService.updateServerUDP:output_type -> pb.RPCSuccess
	46, // 46: pb.ServerService.updateServerWeb:output_type -> pb.RPCSuccess
	46, // 47: pb.ServerService.updateServerReverseProxy:output_type -> pb.RPCSuccess
	13, // 48: pb.ServerService.findServerNames:output_type -> pb.FindServerNamesResponse
	46, // 49: pb.ServerService.updateServerNames:output_type -> pb.RPCSuccess
	46, // 50: pb.ServerService.updateServerNamesAuditing:output_type -> pb.RPCSuccess
	47, // 51: pb.ServerService.countAllEnabledServersMatch:output_type -> pb.RPCCountResponse
	18, // 52: pb.ServerService.listEnabledServersMatch:output_type -> pb.ListEnabledServersMatchResponse
	46, // 53: pb.ServerService.deleteServer:output_type -> pb.RPCSuccess
	21, // 54: pb.ServerService.findEnabledServer:output_type -> pb.FindEnabledServerResponse
	23, // 55: pb.ServerService.findEnabledServerConfig:output_type -> pb.FindEnabledServerConfigResponse
	25, // 56: pb.ServerService.findEnabledServerType:output_type -> pb.FindEnabledServerTypeResponse
	27, // 57: pb.ServerService.findAndInitServerReverseProxyConfig:output_type -> pb.FindAndInitServerReverseProxyConfigResponse
	29, // 58: pb.ServerService.findAndInitServerWebConfig:output_type -> pb.FindAndInitServerWebConfigResponse
	47, // 59: pb.ServerService.countAllEnabledServersWithSSLCertId:output_type -> pb.RPCCountResponse
	32, // 60: pb.ServerService.findAllEnabledServersWithSSLCertId:output_type -> pb.FindAllEnabledServersWithSSLCertIdResponse
	47, // 61: pb.ServerService.countAllEnabledServersWithNodeClusterId:output_type -> pb.RPCCountResponse
	47, // 62: pb.ServerService.countAllEnabledServersWithGroupId:output_type -> pb.RPCCountResponse
	36, // 63: pb.ServerService.notifyServersChange:output_type -> pb.NotifyServersChangeResponse
	38, // 64: pb.ServerService.findAllEnabledServersDNSWithClusterId:output_type -> pb.FindAllEnabledServersDNSWithClusterIdResponse
	41, // 65: pb.ServerService.findEnabledServerDNS:output_type -> pb.FindEnabledServerDNSResponse
	46, // 66: pb.ServerService.checkUserServer:output_type -> pb.RPCSuccess
