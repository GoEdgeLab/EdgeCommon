...
var file_service_server_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xb2, 0x01, 0x0a, 0x22,
	...
	0x22, 0xda, 0x01, 0x0a, 0x1e, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64,
	...
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09,
	0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x75, 0x64,
	0x69, 0x74, 0x69, 0x6e, 0x67, 0x46, 0x6c, 0x61, 0x67, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0c, 0x61, 0x75, 0x64, 0x69, 0x74, 0x69, 0x6e, 0x67, 0x46, 0x6c, 0x61, 0x67, 0x22, 0x47, 0x0a,
	...
	0x28, 0x09, 0x52, 0x0b, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x32,
	0xa9, 0x15, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x73, 0x4f, 0x6e, 0x12, 0x1b, 0x2e, 0x70, 0x62,
	0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x73, 0x4f,
	...
	0x6e, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x12, 0x1a, 0x2e,
	0x70, 0x62, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4e, 0x61, 0x6d,
	0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x70, 0x62, 0x2e, 0x46,
	...
	0x64, 0x69, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x24, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x41, 0x75, 0x64,
	0x69, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x70,
	...
	0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x57, 0x69, 0x74, 0x68, 0x55, 0x73, 0x65,
	0x72, 0x49, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e,
...
var file_service_server_proto_goTypes = []interface{}{
	...
	(*ServerNameAuditingResult)(nil),                       // 45: pb.ServerNameAuditingResult
	(*Server)(nil),                                         // 46: pb.Server
	(*DNSDomain)(nil),                                      // 47: pb.DNSDomain
	(*RPCSuccess)(nil),                                     // 48: pb.RPCSuccess
	(*RPCCountResponse)(nil),                               // 49: pb.RPCCountResponse
}
var file_service_server_proto_depIdxs = []int32{
	45, // 0: pb.FindServerNamesResponse.auditingResult:type_name -> pb.ServerNameAuditingResult
	45, // 1: pb.UpdateServerNamesAuditingRequest.auditingResult:type_name -> pb.ServerNameAuditingResult
	46, // 2: pb.ListEnabledServersMatchResponse.servers:type_name -> pb.Server
	46, // 3: pb.FindEnabledServerResponse.server:type_name -> pb.Server
	46, // 4: pb.FindAllEnabledServersWithSSLCertIdResponse.servers:type_name -> pb.Server
	39, // 5: pb.FindAllEnabledServersDNSWithClusterIdResponse.servers:type_name -> pb.ServerDNSInfo
	47, // 6: pb.FindEnabledServerDNSResponse.domain:type_name -> pb.DNSDomain
	...
	3,  // 9: pb.ServerService.updateServerIsOn:input_type -> pb.UpdateServerIsOnRequest
	4,  // 10: pb.ServerService.updateServerHTTP:input_type -> pb.UpdateServerHTTPRequest
	5,  // 11: pb.ServerService.updateServerHTTPS:input_type -> pb.UpdateServerHTTPSRequest
	6,  // 12: pb.ServerService.updateServerTCP:input_type -> pb.UpdateServerTCPRequest
	7,  // 13: pb.ServerService.updateServerTLS:input_type -> pb.UpdateServerTLSRequest
	8,  // 14: pb.ServerService.updateServerUnix:input_type -> pb.UpdateServerUnixRequest
	9,  // 15: pb.ServerService.updateServerUDP:input_type -> pb.UpdateServerUDPRequest
	10, // 16: pb.ServerService.updateServerWeb:input_type -> pb.UpdateServerWebRequest
	11, // 17: pb.ServerService.updateServerReverseProxy:input_type -> pb.UpdateServerReverseProxyRequest
	12, // 18: pb.ServerService.findServerNames:input_type -> pb.FindServerNamesRequest
	14, // 19: pb.ServerService.updateServerNames:input_type -> pb.UpdateServerNamesRequest
	15, // 20: pb.ServerService.updateServerNamesAuditing:input_type -> pb.UpdateServerNamesAuditingRequest
	16, // 21: pb.ServerService.countAllEnabledServersMatch:input_type -> pb.CountAllEnabledServersMatchRequest
	17, // 22: pb.ServerService.listEnabledServersMatch:input_type -> pb.ListEnabledServersMatchRequest
	19, // 23: pb.ServerService.deleteServer:input_type -> pb.DeleteServerRequest
	20, // 24: pb.ServerService.findEnabledServer:input_type -> pb.FindEnabledServerRequest
	22, // 25: pb.ServerService.findEnabledServerConfig:input_type -> pb.FindEnabledServerConfigRequest
	24, // 26: pb.ServerService.findEnabledServerType:input_type -> pb.FindEnabledServerTypeRequest
	26, // 27: pb.ServerService.findAndInitServerReverseProxyConfig:input_type -> pb.FindAndInitServerReverseProxyConfigRequest
	28, // 28: pb.ServerService.findAndInitServerWebConfig:input_type -> pb.FindAndInitServerWebConfigRequest
	30, // 29: pb.ServerService.countAllEnabledServersWithSSLCertId:input_type -> pb.CountAllEnabledServersWithSSLCertIdRequest
	31, // 30: pb.ServerService.findAllEnabledServersWithSSLCertId:input_type -> pb.FindAllEnabledServersWithSSLCertIdRequest
	33, // 31: pb.ServerService.countAllEnabledServersWithNodeClusterId:input_type -> pb.CountAllEnabledServersWithNodeClusterIdRequest
	34, // 32: pb.ServerService.countAllEnabledServersWithGroupId:input_type -> pb.CountAllEnabledServersWithGroupIdRequest
	35, // 33: pb.ServerService.notifyServersChange:input_type -> pb.NotifyServersChangeRequest
	37, // 34: pb.ServerService.findAllEnabledServersDNSWithClusterId:input_type -> pb.FindAllEnabledServersDNSWithClusterIdRequest
	40, // 35: pb.ServerService.findEnabledServerDNS:input_type -> pb.FindEnabledServerDNSRequest
	42, // 36: pb.ServerService.checkUserServer:input_type -> pb.CheckUserServerRequest
	43, // 37: pb.ServerService.findAllEnabledServerNamesWithUserId:input_type -> pb.FindAllEnabledServerNamesWithUserIdRequest
	1,  // 38: pb.ServerService.createServer:output_type -> pb.CreateServerResponse
	48, // 39: pb.ServerService.updateServerBasic:output_type -> pb.RPCSuccess
	48, // 40: pb.ServerService.updateServerIsOn:output_type -> pb.RPCSuccess
	48, // 41: pb.ServerService.updateServerHTTP:output_type -> pb.RPCSuccess
	48, // 42: pb.ServerService.updateServerHTTPS:output_type -> pb.RPCSuccess
	48, // 43: pb.ServerService.updateServerTCP:output_type -> pb.RPCSuccess
	48, // 44: pb.ServerService.updateServerTLS:output_type -> pb.RPCSuccess
	48, // 45: pb.ServerService.updateServerUnix:output_type -> pb.RPCSuccess
	48, // 46: pb.ServerService.updateServerUDP:output_type -> pb.RPCSuccess
	48, // 47: pb.ServerService.updateServerWeb:output_type -> pb.RPCSuccess
	48, // 48: pb.ServerService.updateServerReverseProxy:output_type -> pb.RPCSuccess
	13, // 49: pb.ServerService.findServerNames:output_type -> pb.FindServerNamesResponse
	48, // 50: pb.ServerService.updateServerNames:output_type -> pb.RPCSuccess
	48, // 51: pb.ServerService.updateServerNamesAuditing:output_type -> pb.RPCSuccess
	49, // 52: pb.ServerService.countAllEnabledServersMatch:output_type -> pb.RPCCountResponse
	18, // 53: pb.ServerService.listEnabledServersMatch:output_type -> pb.ListEnabledServersMatchResponse
	48, // 54: pb.ServerService.deleteServer:output_type -> pb.RPCSuccess
	21, // 55: pb.ServerService.findEnabledServer:output_type -> pb.FindEnabledServerResponse
	23, // 56: pb.ServerService.findEnabledServerConfig:output_type -> pb.FindEnabledServerConfigResponse
	25, // 57: pb.ServerService.findEnabledServerType:output_type -> pb.FindEnabledServerTypeResponse
	27, // 58: pb.ServerService.findAndInitServerReverseProxyConfig:output_type -> pb.FindAndInitServerReverseProxyConfigResponse
	29, // 59: pb.ServerService.findAndInitServerWebConfig:output_type -> pb.FindAndInitServerWebConfigResponse
	49, // 60: pb.ServerService.countAllEnabledServersWithSSLCertId:output_type -> pb.RPCCountResponse
	32, // 61: pb.ServerService.findAllEnabledServersWithSSLCertId:output_type -> pb.FindAllEnabledServersWithSSLCertIdResponse
	49, // 62: pb.ServerService.countAllEnabledServersWithNodeClusterId:output_type -> pb.RPCCountResponse
	49, // 63: pb.ServerService.countAllEnabledServersWithGroupId:output_type -> pb.RPCCountResponse
	36, // 64: pb.ServerService.notifyServersChange:output_type -> pb.NotifyServersChangeResponse
	38, // 65: pb.ServerService.findAllEnabledServersDNSWithClusterId:output_type -> pb.FindAllEnabledServersDNSWithClusterIdResponse
	41, // 66: pb.ServerService.findEnabledServerDNS:output_type -> pb.FindEnabledServerDNSResponse
	48, // 67: pb.ServerService.checkUserServer:output_type -> pb.RPCSuccess
	44, // 68: pb.ServerService.findAllEnabledServerNamesWithUserId:output_type -> pb.FindAllEnabledServerNamesWithUserIdResponse
