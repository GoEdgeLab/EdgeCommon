...
var file_service_server_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xf0, 0x1b, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65,
...
var file_service_server_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_service_server_proto_goTypes = []interface{}{
	...
	(*UploadServerHTTPRequestStatRequest_RegionCity)(nil),            // 59: pb.UploadServerHTTPRequestStatRequest.RegionCity
	(*UploadServerHTTPRequestStatRequest_RegionProvider)(nil),        // 60: pb.UploadServerHTTPRequestStatRequest.RegionProvider
	(*UploadServerHTTPRequestStatRequest_System)(nil),                // 61: pb.UploadServerHTTPRequestStatRequest.System
	(*UploadServerHTTPRequestStatRequest_Browser)(nil),               // 62: pb.UploadServerHTTPRequestStatRequest.Browser
	(*UploadServerHTTPRequestStatRequest_HTTPFirewallRuleGroup)(nil), // 63: pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	(*FindNearbyServersResponse_GroupInfo)(nil),                      // 64: pb.FindNearbyServersResponse.GroupInfo
	(*ServerNameAuditingResult)(nil),                                 // 65: pb.ServerNameAuditingResult
	(*Server)(nil),                                                   // 66: pb.Server
...
var file_service_server_proto_depIdxs = []int32{
	65, // 0: pb.FindServerNamesResponse.auditingResult:type_name -> pb.ServerNameAuditingResult
	65, // 1: pb.UpdateServerNamesAuditingRequest.auditingResult:type_name -> pb.ServerNameAuditingResult
	66, // 2: pb.ListEnabledServersMatchResponse.servers:type_name -> pb.Server
	66, // 3: pb.FindEnabledServerResponse.server:type_name -> pb.Server
	66, // 4: pb.FindAllEnabledServersWithSSLCertIdResponse.servers:type_name -> pb.Server
	41, // 5: pb.FindAllEnabledServersDNSWithNodeClusterIdResponse.servers:type_name -> pb.ServerDNSInfo
	67, // 6: pb.FindEnabledServerDNSResponse.domain:type_name -> pb.DNSDomain
	66, // 7: pb.FindEnabledUserServerBasicResponse.server:type_name -> pb.Server
	59, // 8: pb.UploadServerHTTPRequestStatRequest.regionCities:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionCity
	60, // 9: pb.UploadServerHTTPRequestStatRequest.regionProviders:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionProvider
	61, // 10: pb.UploadServerHTTPRequestStatRequest.systems:type_name -> pb.UploadServerHTTPRequestStatRequest.System
	62, // 11: pb.UploadServerHTTPRequestStatRequest.browsers:type_name -> pb.UploadServerHTTPRequestStatRequest.Browser
	63, // 12: pb.UploadServerHTTPRequestStatRequest.httpFirewallRuleGroups:type_name -> pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	66, // 13: pb.FindLatestServersResponse.servers:type_name -> pb.Server
	64, // 14: pb.FindNearbyServersResponse.groups:type_name -> pb.FindNearbyServersResponse.GroupInfo
	66, // 15: pb.FindNearbyServersResponse.GroupInfo.servers:type_name -> pb.Server
	...
	1,  // 56: pb.ServerService.createServer:output_type -> pb.CreateServerResponse
	68, // 57: pb.ServerService.updateServerBasic:output_type -> pb.RPCSuccess
	68, // 58: pb.ServerService.updateServerIsOn:output_type -> pb.RPCSuccess
	68, // 59: pb.ServerService.updateServerHTTP:output_type -> pb.RPCSuccess
	68, // 60: pb.ServerService.updateServerHTTPS:output_type -> pb.RPCSuccess
	68, // 61: pb.ServerService.updateServerTCP:output_type -> pb.RPCSuccess
	68, // 62: pb.ServerService.updateServerTLS:output_type -> pb.RPCSuccess
	68, // 63: pb.ServerService.updateServerUnix:output_type -> pb.RPCSuccess
	68, // 64: pb.ServerService.updateServerUDP:output_type -> pb.RPCSuccess
	68, // 65: pb.ServerService.updateServerWeb:output_type -> pb.RPCSuccess
	68, // 66: pb.ServerService.updateServerReverseProxy:output_type -> pb.RPCSuccess
	13, // 67: pb.ServerService.findServerNames:output_type -> pb.FindServerNamesResponse
	68, // 68: pb.ServerService.updateServerNames:output_type -> pb.RPCSuccess
	68, // 69: pb.ServerService.updateServerNamesAuditing:output_type -> pb.RPCSuccess
	68, // 70: pb.ServerService.updateServerDNS:output_type -> pb.RPCSuccess
	68, // 71: pb.ServerService.regenerateServerCNAME:output_type -> pb.RPCSuccess
	69, // 72: pb.ServerService.countAllEnabledServersMatch:output_type -> pb.RPCCountResponse
	20, // 73: pb.ServerService.listEnabledServersMatch:output_type -> pb.ListEnabledServersMatchResponse
	68, // 74: pb.ServerService.deleteServer:output_type -> pb.RPCSuccess
	23, // 75: pb.ServerService.findEnabledServer:output_type -> pb.FindEnabledServerResponse
	25, // 76: pb.ServerService.findEnabledServerConfig:output_type -> pb.FindEnabledServerConfigResponse
	27, // 77: pb.ServerService.findEnabledServerType:output_type -> pb.FindEnabledServerTypeResponse
	29, // 78: pb.ServerService.findAndInitServerReverseProxyConfig:output_type -> pb.FindAndInitServerReverseProxyConfigResponse
	31, // 79: pb.ServerService.findAndInitServerWebConfig:output_type -> pb.FindAndInitServerWebConfigResponse
	69, // 80: pb.ServerService.countAllEnabledServersWithSSLCertId:output_type -> pb.RPCCountResponse
	34, // 81: pb.ServerService.findAllEnabledServersWithSSLCertId:output_type -> pb.FindAllEnabledServersWithSSLCertIdResponse
	69, // 82: pb.ServerService.countAllEnabledServersWithNodeClusterId:output_type -> pb.RPCCountResponse
	69, // 83: pb.ServerService.countAllEnabledServersWithServerGroupId:output_type -> pb.RPCCountResponse
	38, // 84: pb.ServerService.notifyServersChange:output_type -> pb.NotifyServersChangeResponse
	40, // 85: pb.ServerService.findAllEnabledServersDNSWithNodeClusterId:output_type -> pb.FindAllEnabledServersDNSWithNodeClusterIdResponse
	43, // 86: pb.ServerService.findEnabledServerDNS:output_type -> pb.FindEnabledServerDNSResponse
	68, // 87: pb.ServerService.checkUserServer:output_type -> pb.RPCSuccess
	46, // 88: pb.ServerService.findAllEnabledServerNamesWithUserId:output_type -> pb.FindAllEnabledServerNamesWithUserIdResponse
	48, // 89: pb.ServerService.findEnabledUserServerBasic:output_type -> pb.FindEnabledUserServerBasicResponse
	68, // 90: pb.ServerService.updateEnabledUserServerBasic:output_type -> pb.RPCSuccess
	68, // 91: pb.ServerService.uploadServerHTTPRequestStat:output_type -> pb.RPCSuccess
	52, // 92: pb.ServerService.checkServerNameDuplicationInNodeCluster:output_type -> pb.CheckServerNameDuplicationInNodeClusterResponse
	54, // 93: pb.ServerService.findLatestServers:output_type -> pb.FindLatestServersResponse
	56, // 94: pb.ServerService.findNearbyServers:output_type -> pb.FindNearbyServersResponse
	58, // 95: pb.ServerService.purgeServerCache:output_type -> pb.PurgeServerCacheResponse
