...
var file_service_server_proto_rawDesc = []byte{
	...
	0x50, 0x6c, 0x61, 0x6e, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x50, 0x6c, 0x61, 0x6e, 0x32, 0xd5,
	0x1e, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
...
var file_service_server_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
var file_service_server_proto_goTypes = []interface{}{
	...
	(*UploadServerHTTPRequestStatRequest_RegionCity)(nil),            // 65: pb.UploadServerHTTPRequestStatRequest.RegionCity
	(*UploadServerHTTPRequestStatRequest_RegionProvider)(nil),        // 66: pb.UploadServerHTTPRequestStatRequest.RegionProvider
	(*UploadServerHTTPRequestStatRequest_System)(nil),                // 67: pb.UploadServerHTTPRequestStatRequest.System
	(*UploadServerHTTPRequestStatRequest_Browser)(nil),               // 68: pb.UploadServerHTTPRequestStatRequest.Browser
	(*UploadServerHTTPRequestStatRequest_HTTPFirewallRuleGroup)(nil), // 69: pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	(*FindNearbyServersResponse_GroupInfo)(nil),                      // 70: pb.FindNearbyServersResponse.GroupInfo
	(*ServerNameAuditingResult)(nil),                                 // 71: pb.ServerNameAuditingResult
	(*Server)(nil),                                                   // 72: pb.Server
	(*DNSDomain)(nil),                                                // 73: pb.DNSDomain
	(*UserPlan)(nil),                                                 // 74: pb.UserPlan
	(*RPCSuccess)(nil),                                               // 75: pb.RPCSuccess
	(*RPCCountResponse)(nil),                                         // 76: pb.RPCCountResponse
}
var file_service_server_proto_depIdxs = []int32{
	71, // 0: pb.FindServerNamesResponse.auditingResult:type_name -> pb.ServerNameAuditingResult
	71, // 1: pb.UpdateServerNamesAuditingRequest.auditingResult:type_name -> pb.ServerNameAuditingResult
	72, // 2: pb.ListEnabledServersMatchResponse.servers:type_name -> pb.Server
	72, // 3: pb.FindEnabledServerResponse.server:type_name -> pb.Server
	72, // 4: pb.FindAllEnabledServersWithSSLCertIdResponse.servers:type_name -> pb.Server
	41, // 5: pb.FindAllEnabledServersDNSWithNodeClusterIdResponse.servers:type_name -> pb.ServerDNSInfo
	73, // 6: pb.FindEnabledServerDNSResponse.domain:type_name -> pb.DNSDomain
	72, // 7: pb.FindEnabledUserServerBasicResponse.server:type_name -> pb.Server
	65, // 8: pb.UploadServerHTTPRequestStatRequest.regionCities:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionCity
	66, // 9: pb.UploadServerHTTPRequestStatRequest.regionProviders:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionProvider
	67, // 10: pb.UploadServerHTTPRequestStatRequest.systems:type_name -> pb.UploadServerHTTPRequestStatRequest.System
	68, // 11: pb.UploadServerHTTPRequestStatRequest.browsers:type_name -> pb.UploadServerHTTPRequestStatRequest.Browser
	69, // 12: pb.UploadServerHTTPRequestStatRequest.httpFirewallRuleGroups:type_name -> pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	72, // 13: pb.FindLatestServersResponse.servers:type_name -> pb.Server
	70, // 14: pb.FindNearbyServersResponse.groups:type_name -> pb.FindNearbyServersResponse.GroupInfo
	74, // 15: pb.FindServerUserPlanResponse.userPlan:type_name -> pb.UserPlan
	72, // 16: pb.FindNearbyServersResponse.GroupInfo.servers:type_name -> pb.Server
	...
	1,  // 61: pb.ServerService.createServer:output_type -> pb.CreateServerResponse
	75, // 62: pb.ServerService.updateServerBasic:output_type -> pb.RPCSuccess
	75, // 63: pb.ServerService.updateServerIsOn:output_type -> pb.RPCSuccess
	75, // 64: pb.ServerService.updateServerHTTP:output_type -> pb.RPCSuccess
	75, // 65: pb.ServerService.updateServerHTTPS:output_type -> pb.RPCSuccess
	75, // 66: pb.ServerService.updateServerTCP:output_type -> pb.RPCSuccess
	75, // 67: pb.ServerService.updateServerTLS:output_type -> pb.RPCSuccess
	75, // 68: pb.ServerService.updateServerUnix:output_type -> pb.RPCSuccess
	75, // 69: pb.ServerService.updateServerUDP:output_type -> pb.RPCSuccess
	75, // 70: pb.ServerService.updateServerWeb:output_type -> pb.RPCSuccess
	75, // 71: pb.ServerService.updateServerReverseProxy:output_type -> pb.RPCSuccess
	13, // 72: pb.ServerService.findServerNames:output_type -> pb.FindServerNamesResponse
	75, // 73: pb.ServerService.updateServerNames:output_type -> pb.RPCSuccess
	75, // 74: pb.ServerService.updateServerNamesAuditing:output_type -> pb.RPCSuccess
	75, // 75: pb.ServerService.updateServerDNS:output_type -> pb.RPCSuccess
	75, // 76: pb.ServerService.regenerateServerCNAME:output_type -> pb.RPCSuccess
	76, // 77: pb.ServerService.countAllEnabledServersMatch:output_type -> pb.RPCCountResponse
	20, // 78: pb.ServerService.listEnabledServersMatch:output_type -> pb.ListEnabledServersMatchResponse
	75, // 79: pb.ServerService.deleteServer:output_type -> pb.RPCSuccess
	23, // 80: pb.ServerService.findEnabledServer:output_type -> pb.FindEnabledServerResponse
	25, // 81: pb.ServerService.findEnabledServerConfig:output_type -> pb.FindEnabledServerConfigResponse
	27, // 82: pb.ServerService.findEnabledServerType:output_type -> pb.FindEnabledServerTypeResponse
	29, // 83: pb.ServerService.findAndInitServerReverseProxyConfig:output_type -> pb.FindAndInitServerReverseProxyConfigResponse
	31, // 84: pb.ServerService.findAndInitServerWebConfig:output_type -> pb.FindAndInitServerWebConfigResponse
	76, // 85: pb.ServerService.countAllEnabledServersWithSSLCertId:output_type -> pb.RPCCountResponse
	34, // 86: pb.ServerService.findAllEnabledServersWithSSLCertId:output_type -> pb.FindAllEnabledServersWithSSLCertIdResponse
	76, // 87: pb.ServerService.countAllEnabledServersWithNodeClusterId:output_type -> pb.RPCCountResponse
	76, // 88: pb.ServerService.countAllEnabledServersWithServerGroupId:output_type -> pb.RPCCountResponse
	38, // 89: pb.ServerService.notifyServersChange:output_type -> pb.NotifyServersChangeResponse
	40, // 90: pb.ServerService.findAllEnabledServersDNSWithNodeClusterId:output_type -> pb.FindAllEnabledServersDNSWithNodeClusterIdResponse
	43, // 91: pb.ServerService.findEnabledServerDNS:output_type -> pb.FindEnabledServerDNSResponse
	75, // 92: pb.ServerService.checkUserServer:output_type -> pb.RPCSuccess
	46, // 93: pb.ServerService.findAllEnabledServerNamesWithUserId:output_type -> pb.FindAllEnabledServerNamesWithUserIdResponse
	48, // 94: pb.ServerService.findEnabledUserServerBasic:output_type -> pb.FindEnabledUserServerBasicResponse
	75, // 95: pb.ServerService.updateEnabledUserServerBasic:output_type -> pb.RPCSuccess
	75, // 96: pb.ServerService.uploadServerHTTPRequestStat:output_type -> pb.RPCSuccess
	52, // 97: pb.ServerService.checkServerNameDuplicationInNodeCluster:output_type -> pb.CheckServerNameDuplicationInNodeClusterResponse
	54, // 98: pb.ServerService.findLatestServers:output_type -> pb.FindLatestServersResponse
	56, // 99: pb.ServerService.findNearbyServers:output_type -> pb.FindNearbyServersResponse
	58, // 100: pb.ServerService.purgeServerCache:output_type -> pb.PurgeServerCacheResponse
	60, // 101: pb.ServerService.findEnabledServerTrafficLimit:output_type -> pb.FindEnabledServerTrafficLimitResponse
	75, // 102: pb.ServerService.updateServerTrafficLimit:output_type -> pb.RPCSuccess
	75, // 103: pb.ServerService.updateServerUserPlan:output_type -> pb.RPCSuccess
	64, // 104: pb.ServerService.findServerUserPlan:output_type -> pb.FindServerUserPlanResponse
