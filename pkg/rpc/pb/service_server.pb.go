...
var file_service_server_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x72, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x32, 0x97, 0x1a, 0x0a,
...
var file_service_server_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_service_server_proto_goTypes = []interface{}{
	...
	(*FindNearbyServersRequest)(nil),                                 // 53: pb.FindNearbyServersRequest
	(*FindNearbyServersResponse)(nil),                                // 54: pb.FindNearbyServersResponse
	(*UploadServerHTTPRequestStatRequest_RegionCity)(nil),            // 55: pb.UploadServerHTTPRequestStatRequest.RegionCity
	(*UploadServerHTTPRequestStatRequest_RegionProvider)(nil),        // 56: pb.UploadServerHTTPRequestStatRequest.RegionProvider
	(*UploadServerHTTPRequestStatRequest_System)(nil),                // 57: pb.UploadServerHTTPRequestStatRequest.System
	(*UploadServerHTTPRequestStatRequest_Browser)(nil),               // 58: pb.UploadServerHTTPRequestStatRequest.Browser
	(*UploadServerHTTPRequestStatRequest_HTTPFirewallRuleGroup)(nil), // 59: pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	(*FindNearbyServersResponse_GroupInfo)(nil),                      // 60: pb.FindNearbyServersResponse.GroupInfo
	(*ServerNameAuditingResult)(nil),                                 // 61: pb.ServerNameAuditingResult
	(*Server)(nil),                                                   // 62: pb.Server
	(*DNSDomain)(nil),                                                // 63: pb.DNSDomain
	(*RPCSuccess)(nil),                                               // 64: pb.RPCSuccess
	(*RPCCountResponse)(nil),                                         // 65: pb.RPCCountResponse
}
var file_service_server_proto_depIdxs = []int32{
	61, // 0: pb.FindServerNamesResponse.auditingResult:type_name -> pb.ServerNameAuditingResult
	61, // 1: pb.UpdateServerNamesAuditingRequest.auditingResult:type_name -> pb.ServerNameAuditingResult
	62, // 2: pb.ListEnabledServersMatchResponse.servers:type_name -> pb.Server
	62, // 3: pb.FindEnabledServerResponse.server:type_name -> pb.Server
	62, // 4: pb.FindAllEnabledServersWithSSLCertIdResponse.servers:type_name -> pb.Server
	39, // 5: pb.FindAllEnabledServersDNSWithNodeClusterIdResponse.servers:type_name -> pb.ServerDNSInfo
	63, // 6: pb.FindEnabledServerDNSResponse.domain:type_name -> pb.DNSDomain
	62, // 7: pb.FindEnabledUserServerBasicResponse.server:type_name -> pb.Server
	55, // 8: pb.UploadServerHTTPRequestStatRequest.regionCities:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionCity
	56, // 9: pb.UploadServerHTTPRequestStatRequest.regionProviders:type_name -> pb.UploadServerHTTPRequestStatRequest.RegionProvider
	57, // 10: pb.UploadServerHTTPRequestStatRequest.systems:type_name -> pb.UploadServerHTTPRequestStatRequest.System
	58, // 11: pb.UploadServerHTTPRequestStatRequest.browsers:type_name -> pb.UploadServerHTTPRequestStatRequest.Browser
	59, // 12: pb.UploadServerHTTPRequestStatRequest.httpFirewallRuleGroups:type_name -> pb.UploadServerHTTPRequestStatRequest.HTTPFirewallRuleGroup
	62, // 13: pb.FindLatestServersResponse.servers:type_name -> pb.Server
	60, // 14: pb.FindNearbyServersResponse.groups:type_name -> pb.FindNearbyServersResponse.GroupInfo
	62, // 15: pb.FindNearbyServersResponse.GroupInfo.servers:type_name -> pb.Server
	...
	16, // 30: pb.ServerService.countAllEnabledServersMatch:input_type -> pb.CountAllEnabledServersMatchRequest
	17, // 31: pb.ServerService.listEnabledServersMatch:input_type -> pb.ListEnabledServersMatchRequest
	19, // 32: pb.ServerService.deleteServer:input_type -> pb.DeleteServerRequest
	20, // 33: pb.ServerService.findEnabledServer:input_type -> pb.FindEnabledServerRequest
	22, // 34: pb.ServerService.findEnabledServerConfig:input_type -> pb.FindEnabledServerConfigRequest
	24, // 35: pb.ServerService.findEnabledServerType:input_type -> pb.FindEnabledServerTypeRequest
	26, // 36: pb.ServerService.findAndInitServerReverseProxyConfig:input_type -> pb.FindAndInitServerReverseProxyConfigRequest
	28, // 37: pb.ServerService.findAndInitServerWebConfig:input_type -> pb.FindAndInitServerWebConfigRequest
	30, // 38: pb.ServerService.countAllEnabledServersWithSSLCertId:input_type -> pb.CountAllEnabledServersWithSSLCertIdRequest
	31, // 39: pb.ServerService.findAllEnabledServersWithSSLCertId:input_type -> pb.FindAllEnabledServersWithSSLCertIdRequest
	33, // 40: pb.ServerService.countAllEnabledServersWithNodeClusterId:input_type -> pb.CountAllEnabledServersWithNodeClusterIdRequest
	34, // 41: pb.ServerService.countAllEnabledServersWithServerGroupId:input_type -> pb.CountAllEnabledServersWithServerGroupIdRequest
	35, // 42: pb.ServerService.notifyServersChange:input_type -> pb.NotifyServersChangeRequest
	37, // 43: pb.ServerService.findAllEnabledServersDNSWithNodeClusterId:input_type -> pb.FindAllEnabledServersDNSWithNodeClusterIdRequest
	40, // 44: pb.ServerService.findEnabledServerDNS:input_type -> pb.FindEnabledServerDNSRequest
	42, // 45: pb.ServerService.checkUserServer:input_type -> pb.CheckUserServerRequest
	43, // 46: pb.ServerService.findAllEnabledServerNamesWithUserId:input_type -> pb.FindAllEnabledServerNamesWithUserIdRequest
	45, // 47: pb.ServerService.findEnabledUserServerBasic:input_type -> pb.FindEnabledUserServerBasicRequest
	47, // 48: pb.ServerService.updateEnabledUserServerBasic:input_type -> pb.UpdateEnabledUserServerBasicRequest
	48, // 49: pb.ServerService.uploadServerHTTPRequestStat:input_type -> pb.UploadServerHTTPRequestStatRequest
	49, // 50: pb.ServerService.checkServerNameDuplicationInNodeCluster:input_type -> pb.CheckServerNameDuplicationInNodeClusterRequest
	51, // 51: pb.ServerService.findLatestServers:input_type -> pb.FindLatestServersRequest
	53, // 52: pb.ServerService.findNearbyServers:input_type -> pb.FindNearbyServersRequest
	1,  // 53: pb.ServerService.createServer:output_type -> pb.CreateServerResponse
	64, // 54: pb.ServerService.updateServerBasic:output_type -> pb.RPCSuccess
	64, // 55: pb.ServerService.updateServerIsOn:output_type -> pb.RPCSuccess
	64, // 56: pb.ServerService.updateServerHTTP:output_type -> pb.RPCSuccess
	64, // 57: pb.ServerService.updateServerHTTPS:output_type -> pb.RPCSuccess
	64, // 58: pb.ServerService.updateServerTCP:output_type -> pb.RPCSuccess
	64, // 59: pb.ServerService.updateServerTLS:output_type -> pb.RPCSuccess
	64, // 60: pb.ServerService.updateServerUnix:output_type -> pb.RPCSuccess
	64, // 61: pb.ServerService.updateServerUDP:output_type -> pb.RPCSuccess
	64, // 62: pb.ServerService.updateServerWeb:output_type -> pb.RPCSuccess
	64, // 63: pb.ServerService.updateServerReverseProxy:output_type -> pb.RPCSuccess
	13, // 64: pb.ServerService.findServerNames:output_type -> pb.FindServerNamesResponse
	64, // 65: pb.ServerService.updateServerNames:output_type -> pb.RPCSuccess
	64, // 66: pb.ServerService.updateServerNamesAuditing:output_type -> pb.RPCSuccess
	65, // 67: pb.ServerService.countAllEnabledServersMatch:output_type -> pb.RPCCountResponse
	18, // 68: pb.ServerService.listEnabledServersMatch:output_type -> pb.ListEnabledServersMatchResponse
	64, // 69: pb.ServerService.deleteServer:output_type -> pb.RPCSuccess
	21, // 70: pb.ServerService.findEnabledServer:output_type -> pb.FindEnabledServerResponse
	23, // 71: pb.ServerService.findEnabledServerConfig:output_type -> pb.FindEnabledServerConfigResponse
	25, // 72: pb.ServerService.findEnabledServerType:output_type -> pb.FindEnabledServerTypeResponse
	27, // 73: pb.ServerService.findAndInitServerReverseProxyConfig:output_type -> pb.FindAndInitServerReverseProxyConfigResponse
	29, // 74: pb.ServerService.findAndInitServerWebConfig:output_type -> pb.FindAndInitServerWebConfigResponse
	65, // 75: pb.ServerService.countAllEnabledServersWithSSLCertId:output_type -> pb.RPCCountResponse
	32, // 76: pb.ServerService.findAllEnabledServersWithSSLCertId:output_type -> pb.FindAllEnabledServersWithSSLCertIdResponse
	65, // 77: pb.ServerService.countAllEnabledServersWithNodeClusterId:output_type -> pb.RPCCountResponse
	65, // 78: pb.ServerService.countAllEnabledServersWithServerGroupId:output_type -> pb.RPCCountResponse
	36, // 79: pb.ServerService.notifyServersChange:output_type -> pb.NotifyServersChangeResponse
	38, // 80: pb.ServerService.findAllEnabledServersDNSWithNodeClusterId:output_type -> pb.FindAllEnabledServersDNSWithNodeClusterIdResponse
	41, // 81: pb.ServerService.findEnabledServerDNS:output_type -> pb.FindEnabledServerDNSResponse
	64, // 82: pb.ServerService.checkUserServer:output_type -> pb.RPCSuccess
	44, // 83: pb.ServerService.findAllEnabledServerNamesWithUserId:output_type -> pb.FindAllEnabledServerNamesWithUserIdResponse
	46, // 84: pb.ServerService.findEnabledUserServerBasic:output_type -> pb.FindEnabledUserServerBasicResponse
	64, // 85: pb.ServerService.updateEnabledUserServerBasic:output_type -> pb.RPCSuccess
	64, // 86: pb.ServerService.uploadServerHTTPRequestStat:output_type -> pb.RPCSuccess
	50, // 87: pb.ServerService.checkServerNameDuplicationInNodeCluster:output_type -> pb.CheckServerNameDuplicationInNodeClusterResponse
	52, // 88: pb.ServerService.findLatestServers:output_type -> pb.FindLatestServersResponse
	54, // 89: pb.ServerService.findNearbyServers:output_type -> pb.FindNearbyServersResponse
