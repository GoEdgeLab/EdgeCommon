...
// UnimplementedIPLibraryArtifactServiceServer can be embedded to have forward compatible implementations.
...
func RegisterIPLibraryArtifactServiceServer(s *grpc.Server, srv IPLibraryArtifactServiceServer) {
	s.RegisterService(&_IPLibraryArtifactService_serviceDesc, srv)
}
...
var _IPLibraryArtifactService_serviceDesc = grpc.ServiceDesc{
